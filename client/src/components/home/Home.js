                ...
                <div className='backdrop'>
                    <div className='rectanglewrapper'>
                        <div className="rectangle">
                            ...
                            <div className='rectangle-titlemargin'>Fishing and tides</div>
                                <div className='fishing'>Tides and fishing conditions are related because tides cause the movement of water. </div>
                                <div className='fishing'>When there is an increase in current or water movement, fish are more likely to feed and are easier to catch.</div>
                                <div className='fishing'>The water movement causes an associated increase in the activity of various marine organisms. </div>
                            </div>
                            <div className="rectangle">
                                <img className="minimoon" src={tide} alt="Tide" />
                                <div className='rectangle-titlemargin'>Extremes</div>
                                <div className="extremes" >Sea level can rise 18 meters!</div>
                                <div className="extremes">Some places on the planet where the influence of the moon's phases on the tide is higher. </div>
                                <div className="extremes">In the Bay of Fundy, Canada, the difference between high and low tides reaches 18 meters.</div>
                                <div className="extremes">On Mont Saint-Michel, on the coast of France, 14 meters. In the Derby region of Australia, 11 meters. In Cook Inlet, on the southern coast of Alaska, the elevation reaches 9 meters</div>
                                <div></div>
                            </div>
                            <div className="rectangle">
